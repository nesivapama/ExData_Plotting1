...
## Sub plot 2
with(electric_df, plot(electric_df$Fulldate, electric_df$Voltage, type = "l", xlab="datetime", ylab = "Voltage"))
## Sub plot 3
...
## Sub plot 4
with(electric_df, plot(electric_df$Fulldate, electric_df$Global_reactive_power, type = "l", xlab="datetime", ylab = "Global_reactive_power"))
dev.off()
